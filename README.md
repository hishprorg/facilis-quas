...
[![UI Tests](https://github.com/hishprorg/facilis-quas/actions/workflows/tests-on-pr.yml/badge.svg?branch=dev)](https://github.com/hishprorg/facilis-quas/actions/workflows/tests-on-pr.yml)

Please submit a PR to https://github.com/hishprorg/facilis-quas-awesome with your website/app/Quasar tutorial/video etc. Thank you!
...
Please make sure to read the [Contributing Guide](./CONTRIBUTING.md) before making a pull request. If you have a Quasar-related project/component/tool, add it with a pull request to [this curated list](https://github.com/hishprorg/facilis-quas-awesome)!

Thank you to all the people who already [contributed to Quasar](https://github.com/hishprorg/facilis-quas/graphs/contributors)!
